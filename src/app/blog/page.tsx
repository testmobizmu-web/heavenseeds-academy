        ...
        <div className="mx-auto max-w-7xl">
          <div className="overflow-hidden rounded-[2rem] bg-[#A84F3F] p-6 text-white shadow-[0_26px_85px_rgba(168,79,63,0.18)] sm:p-8 lg:p-10">
            <div className="grid gap-8 lg:grid-cols-[0.88fr_1.12fr] lg:items-center">
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden bg-[#7F342B]">
                  <Image
                    src={featured.image}
                    alt={featured.title}
                    fill
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#7F342B]/60 via-transparent to-transparent" />
                ...
                <div className="p-5 sm:p-6">
                  ...
                  <div className="mt-5 inline-flex items-center gap-2 rounded-full bg-[#F4B321] px-5 py-2.5 text-sm font-extrabold !text-[#7F342B] shadow-[0_16px_38px_rgba(244,179,33,0.28)]">
                    <span className="text-[#7F342B]">Read featured article</span>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {remainingPosts.map((post) => (
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden bg-[#A84F3F]">
                  <Image
                    src={post.image}
                    alt={post.title}
                    fill
                ...
                <div className="p-5">
                  <div className="flex items-center gap-2 text-xs font-extrabold text-[#A84F3F]">
                    <Clock size={14} />
                    {post.readTime}
                  </div>
                  ...
                  <div className="mt-5 inline-flex items-center gap-2 rounded-full bg-[#F4B321] px-5 py-2.5 text-sm font-extrabold !text-[#7F342B] shadow-[0_16px_35px_rgba(244,179,33,0.24)] transition group-hover:bg-[#FFD46A]">
                    <span className="text-[#7F342B]">Read article</span>
                    <ArrowRight size={16} className="text-[#7F342B]" />
                  </div>
                </div>
              </Link>
          ...
          <div className="mt-10 rounded-[2rem] bg-[#A84F3F] p-6 text-white shadow-[0_26px_85px_rgba(168,79,63,0.18)] sm:p-8 lg:p-10">
