...
const content = {
  ...
  fr: {
    ...
    description:
      "Nous accompagnons les enfants en nurserie et pré-primaire dans leur développement social, émotionnel et leurs premiers apprentissages, dans un cadre inclusif avec des approches pédagogiques adaptées et un partenariat familial.",
    trustItems: [
      {
        icon: Baby,
        title: "Nurserie & Pré-primaire",
        text: "Des bases douces pour la petite enfance avec soin, routine, jeu, découverte et confiance.",
      },
      {
        icon: HeartHandshake,
        title: "Éducation inclusive",
        text: "Un cadre inclusif où les enfants ayant différents besoins sont accompagnés avec patience et structure.",
      },
      {
        icon: UsersRound,
        title: "Développement social",
        text: "Aider l’enfant à développer l’interaction, la participation, la confiance sociale et les relations positives.",
      },
      {
        icon: Brain,
        title: "Apprentissage émotionnel",
        text: "Soutenir la conscience émotionnelle, le calme, le comportement, la confiance et le bien-être.",
      },
      {
        icon: Speech,
        title: "Soutien ergothérapie & orthophonie",
        text: "Un accompagnement global pour la communication, la participation, la préparation sensorielle et la confiance quotidienne.",
      },
      {
        icon: ShieldCheck,
        title: "Sécurité & bienveillance",
        text: "Un environnement rassurant où chaque enfant se sent protégé, valorisé, encouragé et compris.",
      },
    ],
  },
};
